...
![Панель с готовым видео](assets/screenshot-video.png)

*(скриншоты и `assets/demo.mp4` кладутся владельцем проекта вручную, см.
раздел «Что осталось сделать руками» ниже)*
...
- [ ] Сделать `assets/screenshot-chat.png` — диалог с текстовым ответом и
      раскрытым логом вызовов инструментов.
- [ ] Сделать `assets/screenshot-video.png` — панель с готовым видео.
